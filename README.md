    ...
    <head>
        ...
        <style>
            ...
            .calculator-container {
                width: 400px;
                background-color:rgb(152, 19, 123);
                margin: 0 auto; 
                margin-top: 100px;
                text-align: center;
       ...
       background-color:rgb(40, 142, 165);
    text-align: right;
    padding-right: 50px;
    font-size: 25px;
    margin-bottom: 20px; 
...
<body bgcolor="skyblue">
    <h1 align="center" style="color: white">rithik v</h1>
    <h2 align="center" style="color: rgb(234, 47, 14)">212223230171</h2>
...
```
## OUTPUT:
![calculater](https://github.com/23014287rithik/Calc/assets/150985832/c71d67d3-cbed-4c87-aa94-779a010989da)
